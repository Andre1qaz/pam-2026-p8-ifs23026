...
class _TodosDetailScreenState extends State<TodosDetailScreen> {
  ...
  Future<void> _pickCover() async {
    ...
    showAppSnackBar(
      context,
      message: success ? 'Cover berhasil diperbarui.' : provider.errorMessage,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Divider(),
                    _InfoRow(label: 'Dibuat', value: todo.createdAt),
                    const SizedBox(height: 4),
                    _InfoRow(label: 'Diperbarui', value: todo.updatedAt),
                  ],
                ),
              ),
            ),
