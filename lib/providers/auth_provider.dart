...
class AuthProvider extends ChangeNotifier {
  ...
  Future<bool> register({
    ...
    final result = await _repository.register(name: name, username: username, password: password);
    if (result.success) {
  ...
  Future<bool> updateProfile({required String name, required String username}) async {
  ...
  Future<bool> _tryRefreshToken() async {
    ...
    final result = await _repository.refreshToken(
      authToken: _authToken!, refreshToken: _refreshToken!,
    );
    if (result.success && result.data != null) {
      await _saveTokens(
        authToken:    result.data!['authToken']!,
  ...
  Future<void> _saveTokens({required String authToken, required String refreshToken}) async {
